        ...
        <div id="laporanContainer">
            ...
            <div class="laporan-status-container <?php echo ($index !== 0) ? 'hidden' : ''; ?>"
                ...
                <?php foreach ($laporanByStatus[$status] as $row) :
                            $imageUrl = "uploads/" . htmlspecialchars($row['bukti']); // Pastikan path dan nama file aman
                ...
                <a href="detail-laporan?id=<?= htmlspecialchars($row['id']) ?>" class="block laporan-card bg-white rounded-xl shadow-lg overflow-hidden mb-6 cursor-pointer
                    ...
                    <div class="relative">
                        <img src="<?= $imageUrl ?>" alt="Gambar Laporan" class="w-full h-56 sm:h-64 object-cover" />
                        <div
