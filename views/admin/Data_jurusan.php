...
<main class="flex-1 p-6 overflow-y-auto">
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
        <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">Tambah Jurusan Baru</h3>
        <form action="" method="POST">
            <input type="hidden" name="action" value="add">
            <div class="mb-4">
                <label for="add_nama_jurusan" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                    Nama Jurusan
                </label>
                <input type="text" id="add_nama_jurusan" name="nama_jurusan"
                    ...
                    placeholder="Masukkan nama jurusan baru" required>
            </div>
            <button type="submit"
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">Daftar Jurusan</h3>
    ...
    <div id="editJurusanModal"
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md">
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">Edit Jurusan</h3>
            <form action="" method="POST">
...
<script src="../../assets/js/DataJurusan.js"></script>
