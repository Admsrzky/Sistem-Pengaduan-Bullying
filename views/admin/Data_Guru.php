...
include '../../controllers/GuruController.php';
?>
...
<main class="flex-1 p-6 overflow-y-auto">
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">Daftar Guru</h3>
            ...
            <table class="min-w-full leading-normal">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td
                            class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-200">
                            <?= htmlspecialchars($guru['nama_jabatan'] ?? 'N/A') ?>
                        </td>
                        <td
                            class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-200">
                            <img src="<?= $asset_base_path_users . htmlspecialchars($guru['foto_profile'] ?? 'default.png') ?>"
                                alt="Foto Profil" class="w-10 h-10 rounded-full object-cover">
                        </td>
                        <td
                            class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-200">
                            <?= htmlspecialchars($guru['created_at'] ? date('d M Y H:i', strtotime($guru['created_at'])) : 'N/A') ?>
                        </td>
                        <td
                            class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-200">
                            <?= htmlspecialchars($guru['updated_at'] ? date('d M Y H:i', strtotime($guru['updated_at'])) : 'N/A') ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
...
<script>
// No specific JavaScript needed for this display-only page,
// except for feather icons if used in header.php or other common elements.
